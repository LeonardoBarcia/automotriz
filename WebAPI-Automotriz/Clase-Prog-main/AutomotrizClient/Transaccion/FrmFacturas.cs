...
namespace AutomotrizClient
{
    public partial class FrmFacturas : Form
    {
        ...
        {
            #region VALIDACIONES
            if (cboPlan.Text.Equals(String.Empty))
            {
                MessageBox.Show("Debe ingresar un plan", "Control", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void dgvDetalles1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

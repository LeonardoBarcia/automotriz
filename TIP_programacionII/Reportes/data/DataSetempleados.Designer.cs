...
namespace TIP_programacionII.Reportes.data {
...
namespace TIP_programacionII.Reportes.data.DataSetempleadosTableAdapters {
    ...
    public partial class EmpleadosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Empleados] WHERE (([legajo] = @Original_legajo) AND ((@IsNull_nombre" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Empleados] ([nombre]) VALUES (@nombre);\r\nSELECT legajo, nombre FROM " +
                "Empleados WHERE (legajo = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Empleados] SET [nombre] = @nombre WHERE (([legajo] = @Original_legajo) AN" +
                "D ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)));" +
                "\r\nSELECT legajo, nombre FROM Empleados WHERE (legajo = @legajo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=LEONARDODJ-PC\\SQLEXPRESS;Initial Catalog=AutomotrizDB_PROG;Integrated" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        legajo, nombre\r\nFROM            Empleados";
        ...
        public virtual int Delete(int Original_legajo, string Original_nombre) {
        ...
        public virtual int Update(string nombre, int Original_legajo, string Original_nombre, int legajo) {
            if ((nombre == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Original_legajo));
            if ((Original_nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, int Original_legajo, string Original_nombre) {
            return this.Update(nombre, Original_legajo, Original_nombre, Original_legajo);
        }
    }
